...
import EfficientFrontierDashboard from "./EfficientFrontierDashboard.jsx"; // Check this path!
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 text-center">
                ...
                <div className="relative mx-auto max-w-6xl transition-all duration-1000" id="terminal-view">
                    {!isAuthenticated && (
                        <div className="absolute inset-0 z-10 backdrop-blur-sm bg-slate-950/60 rounded-xl flex flex-col items-center justify-center border border-white/10">
